-- @description: Extend selected automation items at end by 1 grid
-- @version: 1.0
-- @author: BIXIDOX
-- @assistant: GPT-5
-- @changelog: Initial release
-- @about:
-- Extends automation items from the end by one grid division, snapped to project grid.
...
--[[============================================================================]]                                --                            --
    ...
    if changed then                                                             --                                --                            --
                                                                                --                                --                            --
        r.UpdateArrange()                                                       --                                --                            --
        r.Undo_EndBlock("Extend selected automation items end by 1 grid", -1)   --                                --                            --
                                                                                --                                --                            --
    else                                                                        --                                --                            --
                                                                                --                                --                            --
