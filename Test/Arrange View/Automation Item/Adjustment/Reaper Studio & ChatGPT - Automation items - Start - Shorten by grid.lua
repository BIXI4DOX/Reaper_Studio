-- @description: Shorten selected automation items at start by 1 grid
-- @version: 1.0
-- @author: BIXIDOX
-- @assistant: GPT-5
-- @changelog: Initial release
-- @about:
-- Shortens automation items from the start by one grid division, snapped to project grid.
        ...
        for e = 0, r.CountTrackEnvelopes(tr)-1 do                                               --                         --                          --
            ...
            for i = 0, r.CountAutomationItems(env)-1 do                                         --                         --                          --
                ...
                if r.GetSetAutomationItemInfo(env, i, "D_UISEL", 0, false) == 1 then            --                         --                          --
                    ...
                    local endp = pos + len                                                      --                         --                          --                                                                                                --                         --                          --
                    local snappedStart = r.SnapToGrid(0, pos)                                   --                         --                          --
...
--[[==============================================================================]]                                       --                          --
    ...
    if changed then                                                               --                                       --                          --
                                                                                  --                                       --                          --
        r.UpdateArrange()                                                         --                                       --                          --
        r.Undo_EndBlock("Shorten selected automation items start by 1 grid", -1)  --                                       --                          --
                                                                                  --                                       --                          --
    else                                                                          --                                       --                          --
                                                                                  --                                       --                          --
