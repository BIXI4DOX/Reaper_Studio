-- @description: Extend selected automation items at start by 1 grid
-- @version: 1.0
-- @author: BIXIDOX
-- @assistant: GPT-5
-- @changelog: Initial release
-- @about:
-- Extends automation items from the start by one grid division, snapped to project grid.
        ...
        for e = 0, r.CountTrackEnvelopes(tr)-1 do                                                 --              --                --
            ...
            for i = 0, r.CountAutomationItems(env)-1 do                                           --              --                --
                ...
                if r.GetSetAutomationItemInfo(env, i, "D_UISEL", 0, false) == 1 then              --              --                --
                    ...
                    local endp = pos + len                                                        --              --                --
                    local snappedStart = r.SnapToGrid(0, pos)                                     --              --                -- snap current start to grid before adjusting
                    local newStart = r.SnapToGrid(0, snappedStart - grid)                         --              --                --
                    local newLen = endp - newStart                                                --              --                --
                                                                                                  --              --                --
                    if newLen > 0 then                                                            --              --                --
                                                                                                  --              --                --
                        r.GetSetAutomationItemInfo(env, i, "D_POSITION", newStart, true)          --              --                --
...
--[[============================================================================]]                                --                --
    ...
    if changed then                                                             --                                --                --
                                                                                --                                --                --
        r.UpdateArrange()                                                       --                                --                --
        r.Undo_EndBlock("Extend selected automation items start by 1 grid", -1) --                                --                --
                                                                                --                                --                --
    else                                                                        --                                --                --
                                                                                --                                --                --
