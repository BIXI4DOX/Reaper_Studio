...
--	[main] Reaper Studio - Automation items - Adjustment - Length - Start - Shorten - Grid.lua
--	[main] Reaper Studio - Automation Items - Adjustment - Position - Left - Grid.lua
--	[main] Reaper Studio - Automation Items - Adjustment - Position - Right - Grid.lua
